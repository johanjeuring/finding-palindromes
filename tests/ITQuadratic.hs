...
testITQuadratic1 =
    "testITQuadratic1"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectLongest
            AlgQuadratic{algGapSize = 0, algMaxErrors = 1}
            0
            "AG\nTC"
        ~?= "[2,2,2]"
...
testITQuadratic2 =
    "testITQuadratic2"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgQuadratic{algGapSize = 0, algMaxErrors = 0}
            4
            "A&T-AT"
        ~?= "\"A&T-AT\""
...
testITQuadratic3 =
    "testITQuadratic3"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgQuadratic{algGapSize = 4, algMaxErrors = 4}
            1
            "AGTC"
        ~?= "[2,4,2]"
...
testITQuadratic4 =
    "testITQuadratic4"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgQuadratic{algGapSize = 2, algMaxErrors = 0}
            2
            "ACCT"
        ~?= "[2,4,2]"
...
testITQuadratic5 =
    "testITQuadratic5"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgQuadratic{algGapSize = 1, algMaxErrors = 2}
            3
            "“AC\nTA..,TTCT”"
        ~?= "\"AC\nT\"\n\"AC\nTA\"\n\"AC\nTA..,T\"\n\"AC\nTA..,TT\"\n\"C\nTA..,TT\"\n\"AC\nTA..,TTCT\"\n\"C\nTA..,TTCT\"\n\"A..,TTC\"\n\"A..,TTCT\"\n\"TTCT\"\n\"TCT\""
...
testITQuadratic10 =
    "testITQuadratic10"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgQuadratic{algGapSize = 5, algMaxErrors = 5}
            0
            "A;G;G;G;T"
        ~?= "\"\"\n\"A\"\n\"A;G\"\n\"A;G;G\"\n\"A;G;G;G\"\n\"A;G;G;G;T\"\n\"G;G;G;T\"\n\"G;G;T\"\n\"G;T\"\n\"T\"\n\"\""
...
testITQuadratic14 =
    "testITQuadratic14"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgQuadratic{algGapSize = 6, algMaxErrors = 6}
            1
            "abcdef"
...
testITQuadratic21 =
    "testITQuadratic21"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgQuadratic{algGapSize = 10, algMaxErrors = 10}
            2
            "zat.,s&tat"
...
testITQuadratic26 =
    "testITQuadratic26"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgQuadratic{algGapSize = 3, algMaxErrors = 2}
            4
            "ABcdeBA"
        ~?= "\"ABcdeBA\""
...
testITQuadratic28 =
    "testITQuadratic28"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgQuadratic{algGapSize = 9, algMaxErrors = 9}
            0
            "blaAPPAbl"
        ~?= "\"\"\n\"b\"\n\"bl\"\n\"bla\"\n\"blaA\"\n\"blaAP\"\n\"blaAPP\"\n\"blaAPPA\"\n\"blaAPPAb\"\n\"blaAPPAbl\"\n\"laAPPAbl\"\n\"aAPPAbl\"\n\"APPAbl\"\n\"PPAbl\"\n\"PAbl\"\n\"Abl\"\n\"bl\"\n\"l\"\n\"\""
...
testITQuadratic33 =
    "testITQuadratic33"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgQuadratic{algGapSize = 10, algMaxErrors = 5}
            0
            "bla\\AP.PA.bli"
        ~?= "\"\"\n\"\"\n\"\"\n\"bla\"\n\"\"\n\"bla\\AP\"\n\"\"\n\"bla\\AP.PA\"\n\"AP\"\n\"\"\n\"bla\\AP.PA.bli\"\n\"\"\n\"PA\"\n\"AP.PA.bli\"\n\"\"\n\"PA.bli\"\n\"\"\n\"bli\"\n\"\"\n\"\"\n\"\""
...
testITQuadratic40 =
    "testITQuadratic40"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectLongest
            AlgQuadratic{algGapSize = 6, algMaxErrors = 3}
            5
            "abcdef"
        ~?= "[6]"
...
testITQuadratic44 =
    "testITQuadratic44"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgQuadratic{algGapSize = 5, algMaxErrors = 2}
            3
            "lepel"
        ~?= "\"lep\"\n\"lepe\"\n\"lepel\"\n\"epel\"\n\"pel\""
...
testITQuadratic48 =
    "testITQuadratic48"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgQuadratic{algGapSize = 7, algMaxErrors = 7}
            2
            "zatstat"
        ~?= "\"zatstat\""
...
testITQuadratic51 =
    "testITQuadratic51"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgQuadratic{algGapSize = 0, algMaxErrors = 8}
            6
            "A-B*cde)BA"
        ~?= "[6,7,6]"
...
testITQuadratic52 =
    "testITQuadratic52"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgQuadratic{algGapSize = 3, algMaxErrors = 0}
            2
            "ABcdeBA"
