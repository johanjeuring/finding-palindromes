...
testITApproximate1 =
    "testITApproximate1"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectLongest
            AlgApproximate{algGapSize = 0, algMaxError = 1}
            0
            "AG\nTC"
        ~?= "[3,3]"
...
testITApproximate2 =
    "testITApproximate2"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgApproximate{algGapSize = 0, algMaxError = 0}
            4
            "A&T-AT"
        ~?= "\"A&T-AT\""
...
testITApproximate3 =
    "testITApproximate3"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgApproximate{algGapSize = 0, algMaxError = 4}
            1
            "AGTC"
        ~?= "[4]"
...
testITApproximate4 =
    "testITApproximate4"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgApproximate{algGapSize = 2, algMaxError = 0}
            2
            "ACCT"
        ~?= "[2,2,4]"
...
testITApproximate5 =
    "testITApproximate5"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgApproximate{algGapSize = 1, algMaxError = 2}
            3
            "“AC\nTA..,TTCT”"
        ~?= "\"AC\nTA..,TTCT\""
...
testITApproximate7 =
    "testITApproximate7"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgApproximate{algGapSize = 4, algMaxError = 4}
            2
            "Ac\nC,T”"
        ~?= "\"Ac\nC,T\""
...
testITApproximate10 =
    "testITApproximate10"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgApproximate{algGapSize = 5, algMaxError = 5}
            0
            "A;G;G;G;T"
        ~?= "\"A;G;G;G;T\""
...
testITApproximate14 =
    "testITApproximate14"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgApproximate{algGapSize = 0, algMaxError = 6}
            1
            "abcdef"
        ~?= "[6]"
...
testITApproximate15 =
    "testITApproximate15"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectLongest
            AlgApproximate{algGapSize = 0, algMaxError = 2}
            3
            "a’b/ba"
        ~?= "[6]"
...
testITApproximate21 =
    "testITApproximate21"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgApproximate{algGapSize = 0, algMaxError = 10}
            2
            "zat.,s&tat"
        ~?= "[10]"
...
testITApproximate25 =
    "testITApproximate25"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgApproximate{algGapSize = 10, algMaxError = 10}
            2
            "A-B*cde)BA"
        ~?= "\"A-B*cde)BA\""
...
testITApproximate26 =
    "testITApproximate26"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgApproximate{algGapSize = 3, algMaxError = 2}
            4
            "ABcdeBA"
        ~?= "\"ABcdeBA\""
...
testITApproximate28 =
    "testITApproximate28"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgApproximate{algGapSize = 0, algMaxError = 9}
            0
            "blaAPPAbl"
        ~?= "\"blaAPPAbl\""
...
testITApproximate33 =
    "testITApproximate33"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgApproximate{algGapSize = 0, algMaxError = 5}
            0
            "bla\\AP.PA.bli"
        ~?= "\"bla\\AP.PA.bli\""
...
testITApproximate40 =
    "testITApproximate40"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectLongest
            AlgApproximate{algGapSize = 0, algMaxError = 3}
            5
            "abcdef"
        ~?= "[6]"
...
testITApproximate48 =
    "testITApproximate48"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgApproximate{algGapSize = 0, algMaxError = 7}
            2
            "zatstat"
        ~?= "\"zatstat\""
...
testITApproximate51 =
    "testITApproximate51"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgApproximate{algGapSize = 0, algMaxError = 8}
            6
            "A-B*cde)BA"
        ~?= "[7]"
...
testITApproximate52 =
    "testITApproximate52"
        ~: findPalindromesFormatted
            ...
            FormatLength
            SelectAll
            AlgApproximate{algGapSize = 3, algMaxError = 0}
            2
            "ABcdeBA"
        ~?= "[3,3,3,3,7]"
...
testITApproximate68 =
    "testITApproximate68"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectAll
            AlgApproximate{algGapSize = 2, algMaxError = 1}
            3
...
testITApproximate69 =
    "testITApproximate69"
        ~: findPalindromesFormatted
            ...
            FormatText
            SelectLongest
            AlgApproximate{algGapSize = 3, algMaxError = 1}
            4
