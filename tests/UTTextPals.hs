...
testTextPalindrome1, testTextPalindrome2, testTextPalindrome3, testTextPalindrome4, 
  ...
  testTextPalindrome9, testTextPalindrome10, testTextPalindrome11 :: Flag -> Test
...
testTextPalindrome1 t = TestCase 
    $ assertEqual "textPalindrome1"  "\"a,ba.\""  
    $ longestTextPalindrome t $ BC.pack "abcdea,ba."

testTextPalindrome2 t = TestCase 
    $ assertEqual "textPalindrome2" "\"a,ba\"" 
    $ longestTextPalindrome t $ BC.pack "abcdea,ba"
           
testTextPalindrome3 t = TestCase 
    $ assertEqual "textPalindrome3" "\".a,ba\"" 
    $ longestTextPalindrome t $ BC.pack "abcde.a,ba"

testTextPalindrome4 t = TestCase 
    $ assertEqual "textPalindrome4" "\".a,ba\"" 
    $ longestTextPalindrome t $ BC.pack "abcde.a,baf"

testTextPalindrome5 t = TestCase 
    $ assertEqual "textPalindrome5" "\".ab,a\"" 
    $ longestTextPalindrome t $ BC.pack ".ab,acdef"

testTextPalindrome6 t = TestCase 
    $ assertEqual "textPalindrome6" "\"ab,a\"" 
    $ longestTextPalindrome t $ BC.pack "ab,acdef"
  
testTextPalindrome7 t = TestCase 
    $ assertEqual "textPalindrome7" "\"ab,a.\"" 
    $ longestTextPalindrome t $ BC.pack "ab,a.cdef"

testTextPalindrome8 t = TestCase 
    $ assertEqual "textPalindrome8" "\".ab,a.\"" 
    $ longestTextPalindrome t $ BC.pack "g.ab,a.cdef"

testTextPalindrome9 t = TestCase 
